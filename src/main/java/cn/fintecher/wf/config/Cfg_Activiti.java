...
import cn.fintecher.wf.utils.activiti.JavascriptFormType;
import cn.fintecher.wf.utils.activiti.MyFormEngine;
...
public class Cfg_Activiti {
    ...
    public ProcessEngineConfiguration processEngineConfiguration(DataSource dataSource, PlatformTransactionManager transactionManager){
        ...
        // 自定义表单引擎
        List<FormEngine> customFormEngines = new ArrayList<FormEngine>();
        customFormEngines.add(new MyFormEngine());
